...
def get_firmware_info_generic(plugin_object):
    ...
    firmware_inventory_attribute = grab(update_service_data, "FirmwareInventory")

    if isinstance(firmware_inventory_attribute, dict):
        firmware_inventory_url = grab(update_service_data, "FirmwareInventory/@odata.id", separator="/")
